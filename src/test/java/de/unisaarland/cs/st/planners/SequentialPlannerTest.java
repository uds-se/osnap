...
public class SequentialPlannerTest {
    ...
    @Test
    public void sequentialPlannerTestWithEmptyImage() {
	...
	SequentialPlanner robinPlanner = new SequentialPlanner();
    ...
    @Test
    public void sequentialPlannerTestWithEmptyFull() {
	...
	Schedule robinSchedule = robinPlanner.computeSchedule(driver.testJobs, driver.availableImages, fullImage,
		driver.cloudModel, driver.goal);
	System.out.println("sequentialPlannerTestWithEmptyFull With Full Image:\n" + robinSchedule);

    }

    @Test
    public void sequentialWithOSnapTest() {
	DataDriver driver = DataDriver.createTestData();
	System.out.println("TestExecutionPlanner.main()\n" + driver.printInputData());
	...
	//
	SequentialPlannerWithOpportunisticSnapshot planner = new SequentialPlannerWithOpportunisticSnapshot();
	Schedule schedule = planner.computeSchedule(driver.testJobs, driver.availableImages, emptyImage,
		driver.cloudModel, driver.goal);

	System.out.println("SequentialPlannerWithOpportunisticSnapshot.main() With Empty Image:\n" + schedule);

	planner = new SequentialPlannerWithOpportunisticSnapshot();
	...
	System.out.println("SequentialPlannerWithOpportunisticSnapshot.main() With Full Image :\n" + schedule);
    }
