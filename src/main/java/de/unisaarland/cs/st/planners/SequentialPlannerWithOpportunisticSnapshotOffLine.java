 ...
 *
 */
public class SequentialPlannerWithOpportunisticSnapshotOffLine extends TestExecutionPlanner {

    public static final String NAME = "SequentialPlannerWithOpportunisticSnapshotOffLine";
    ...
    public SequentialPlannerWithOpportunisticSnapshotOffLine() {
